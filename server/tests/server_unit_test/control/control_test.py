...
def test_handle_import_when_max_charging():
    ...
    # Grid power: PV(-0) + household_load(15000) + battery_power(5000) = 20000W
    grid_power = 20000
    ...
    battery_power, state = handle_import(grid_power, grid_import_power_limit, instantaneous_battery_power, battery_soc, battery_max_charge_discharge_power, min_battery_soc)
...
def test_handle_import_when_max_discharging():
    ...
    # Grid power: PV(-0) + household_load(15000) + battery_power(-5000) = 10000W
    grid_power = 10000
    instantaneous_battery_power = -5000
...
def test_handle_import_when_over_limit():
    ...
    # Grid power: PV(-0) + household_load(15001) + battery_power(0) = 15001W
    grid_power = 15001
...
def test_handle_export_when_under_limit():
    ...
    # Grid power: PV(0) + household_load(10000) + battery_power(0) = 10000W
    grid_power = 10000
    instantaneous_battery_power = 0
...
def test_handle_import_battery_soc_too_low():
    ...
    # Grid power: PV(0) + household_load(15000) + battery_power(0) = 15000W
    grid_power = 15000
    instantaneous_battery_power = 0
...
def test_handle_import_partial_discharge_needed():
    ...
    # Grid power: PV(0) + household_load(12000) + battery_power(1000) = 13000W
    grid_power = 13000
...
def test_handle_import_exact_power_match():
    ...
    # Grid power: PV(-5000) + household_load(15000) + battery_power(0) = 10000W
    grid_power = 10000
...
def test_handle_import_small_adjustment_needed():
    ...
    # Grid power: PV(0) + household_load(10500) + battery_power(0) = 10500W
    grid_power = 10500
    instantaneous_battery_power = 0
...
def test_handle_import_when_already_optimal():
    ...
    # Grid power: PV(0) + household_load(12000) + battery_power(-2000) = 10000W
    grid_power = 10000
...
def test_handle_import_moderate_charging_state():
    ...
    # Grid power: PV(0) + household_load(13000) + battery_power(2000) = 15000W
    grid_power = 15000
...
def test_handle_import_with_pv_generation():
    ...
    # Grid power: PV(-3000) + household_load(15000) + battery_power(1000) = 13000W
    grid_power = 13000
